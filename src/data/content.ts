...
export const uiCopy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    heroStat1Value: "9+",
    heroStat1Label: "Years in security and law enforcement",
    heroStat2Value: "200+",
    heroStat2Label: "Personnel coordinated in field operations",
    heroStat3Value: "16",
    heroStat3Label: "Public and CV-sourced projects documented here",
    contactCta: "Contact",
  ...
  ar: {
    ...
    heroStat1Value: "+9",
    heroStat1Label: "سنوات في الأمن وإنفاذ القانون",
    heroStat2Value: "+200",
    heroStat2Label: "فرد جرى تنسيق عملهم ميدانيًا",
    heroStat3Value: "16",
    heroStat3Label: "مشروعًا عامًا أو موثقًا بالسيرة الذاتية مذكورًا هنا",
    contactCta: "تواصل",
